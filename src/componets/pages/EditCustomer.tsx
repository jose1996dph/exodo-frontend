...
export default function EditCustomer({ open, toggleDrawer }: EditCustomerPageProps) {
  ...
  const loadCustomer = async () => {
    try {
      ...
      /*
      setDni(_customer.dni)
      setBusinessName(_customer.firstName)
      setStoreName(_customer.lastName)
      setAddress(_customer.lastName)
      setReferencePoint(_customer.lastName)
      setPhone(_customer.phone)
      setContactName(_customer.role.id.toString())
      setContactPhone(_customer.email)
      */
    } catch {
      console.error('error')
    }
